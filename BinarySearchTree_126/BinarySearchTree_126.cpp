...
public:
    ...
    void insert(string element) // Insert a node in the binary search tree
    {
        ...
        else if (element > parent->info) // If the value in the field of the new node is greater than that of the parent
        {
    ...
    {
        // This function searches the currentNode of the specified a node as well as the current Node of its parent
        currentNode = ROOT;
        parent = NULL;
